...
df = pd.read_csv("C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_UPWR/PRACA_MAGISTERSKA/SYSTEMATIC_SIM/HETEROSCEDASTICITY/Hetero_mean.txt")

'''
plt.subplot(1,2,1)
plt.gca().set_facecolor('papayawhip')
plt.plot(df.iloc[:,0], df.iloc[:,1], color = 'blue')
plt.title("Mean of the empirical distribution of diff across the strength of\nthe heteroscedasticity coefficient.", fontsize = 8)
plt.xlabel("Heteroscedasticity coefficient")
...
df2 = pd.read_csv("C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_UPWR/PRACA_MAGISTERSKA/SYSTEMATIC_SIM/HETEROSCEDASTICITY/Hetero_median.txt")
...
plt.title("Mean of the empirical distribution of diff across the strength of\nthe heteroscedasticity coefficient.", fontsize = 10)
plt.xlabel("Heteroscedasticity coefficient")
plt.ylabel("Empirical mean")
plt.grid()
plt.legend()
