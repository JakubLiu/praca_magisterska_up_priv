...
df = pd.read_csv("C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_UPWR/PRACA_MAGISTERSKA/SYSTEMATIC_SIM/NOISE/Noise_mean.txt")

'''
plt.subplot(1,2,1)
plt.gca().set_facecolor('papayawhip')
plt.plot(df.iloc[:,0], df.iloc[:,1], color = 'blue')
plt.title("Mean of the empirical distribution of diff across the strength of the noise.", fontsize = 10)
...
plt.title("Variance of the empirical distribution of diff across the strength of the noise.", fontsize = 10)
plt.xlabel("Noise strength")
...
df2 = pd.read_csv("C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_UPWR/PRACA_MAGISTERSKA/SYSTEMATIC_SIM/NOISE/Noise_median.txt")
