...
df = pd.read_csv("C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_UPWR/PRACA_MAGISTERSKA/SYSTEMATIC_SIM/OPTIMUM_SIM/PREDICTOR_CORRELATION/PredCor_sim_mean.csv")

plt.subplot(1,2,1)
plt.gca().set_facecolor('papayawhip')
plt.plot(df.iloc[:,0], df.iloc[:,1], color = 'blue')
plt.title("Mean of the empirical distribution of diff across the strength of the predictor correlations.", fontsize = 10)
...
plt.title("Variance of the empirical distribution of diff across the strength of the predictor correlations.", fontsize = 10)
plt.xlabel("Predictor correlation")
...
plt.gcf().text(0.18, 0.80, text1, transform=plt.gcf().transFigure, fontsize=8,
...
df2 = pd.read_csv("C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_UPWR/PRACA_MAGISTERSKA/SYSTEMATIC_SIM/OPTIMUM_SIM/PREDICTOR_CORRELATION/PredCor_sim_median.csv")
